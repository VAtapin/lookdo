...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $plans = [
            ['code' => 'start', 'name' => ['de' => 'Start', 'en' => 'Start', 'ru' => 'Старт', 'uk' => 'Старт'], 'description' => ['de' => 'Für Einzelmeister mit visuellen Anfragen oder einfacher Terminbuchung.', 'en' => 'For solo specialists with visual enquiries or simple booking.', 'ru' => 'Для частного мастера с визуальными заявками или простой записью.', 'uk' => 'Для приватного майстра з візуальними заявками або простим записом.'], 'price_monthly' => 19, 'price_yearly' => 190, 'prices' => ['EUR' => ['monthly' => 19, 'yearly' => 190], 'RUB' => ['monthly' => 1990, 'yearly' => 19900], 'UAH' => ['monthly' => 890, 'yearly' => 8900]], 'sort_order' => 10, 'entitlements' => ['requests_monthly' => '100', 'storage_mb' => '2048', 'request_enabled' => '1', 'booking_enabled' => '1', 'services_enabled' => '1', 'customers_enabled' => '1', 'video_enabled' => '0', 'custom_domain' => '0', 'staff_users' => '1', 'app_languages' => '1', 'branding_colors' => '1', 'push_enabled' => '1', 'sms_enabled' => '0', 'sms_monthly_limit' => '0']],
            ['code' => 'pro', 'name' => ['de' => 'Pro', 'en' => 'Pro', 'ru' => 'Профессиональный', 'uk' => 'Професійний'], 'description' => ['de' => 'Domain, Video, Erinnerungen und Kundenbindung für wachsende Betriebe.', 'en' => 'Domain, video, reminders and retention for growing businesses.', 'ru' => 'Домен, видео, напоминания и возврат клиентов для растущего бизнеса.', 'uk' => 'Домен, відео, нагадування та повернення клієнтів для бізнесу, що зростає.'], 'price_monthly' => 39, 'price_yearly' => 390, 'prices' => ['EUR' => ['monthly' => 39, 'yearly' => 390], 'RUB' => ['monthly' => 3990, 'yearly' => 39900], 'UAH' => ['monthly' => 1790, 'yearly' => 17900]], 'sort_order' => 20, 'badge_text' => ['de' => 'Empfohlen', 'en' => 'Recommended', 'ru' => 'Рекомендуем', 'uk' => 'Рекомендуємо'], 'entitlements' => ['requests_monthly' => '500', 'storage_mb' => '10240', 'request_enabled' => '1', 'booking_enabled' => '1', 'services_enabled' => '1', 'customers_enabled' => '1', 'reminders_enabled' => '1', 'before_after_enabled' => '1', 'social_content_enabled' => '1', 'video_enabled' => '1', 'video_max_mb' => '100', 'video_max_seconds' => '45', 'custom_domain' => '1', 'staff_users' => '3', 'app_languages' => '2', 'branding_colors' => '1', 'platform_branding_removable' => '1', 'push_enabled' => '1', 'sms_enabled' => '0', 'sms_monthly_limit' => '0', 'telegram_integration' => '1']],
            ['code' => 'business', 'name' => ['de' => 'Business', 'en' => 'Business', 'ru' => 'Бизнес', 'uk' => 'Бізнес'], 'description' => ['de' => 'Für Teams mit KI, erweiterten Kommunikations- und Integrationsfunktionen.', 'en' => 'For teams with AI, advanced communication and integrations.', 'ru' => 'Для команд с AI, расширенными коммуникациями и интеграциями.', 'uk' => 'Для команд з AI, розширеними комунікаціями та інтеграціями.'], 'price_monthly' => 79, 'price_yearly' => 790, 'prices' => ['EUR' => ['monthly' => 79, 'yearly' => 790], 'RUB' => ['monthly' => 7990, 'yearly' => 79900], 'UAH' => ['monthly' => 3590, 'yearly' => 35900]], 'sort_order' => 30, 'entitlements' => ['requests_monthly' => '0', 'storage_mb' => '51200', 'request_enabled' => '1', 'booking_enabled' => '1', 'services_enabled' => '1', 'customers_enabled' => '1', 'reminders_enabled' => '1', 'repeat_visit_enabled' => '1', 'vacancy_fill_enabled' => '1', 'segments_enabled' => '1', 'before_after_enabled' => '1', 'ai_media_enabled' => '1', 'ai_communication_enabled' => '1', 'social_content_enabled' => '1', 'video_enabled' => '1', 'video_max_mb' => '250', 'video_max_seconds' => '90', 'custom_domain' => '1', 'staff_users' => '10', 'app_languages' => '4', 'branding_colors' => '1', 'platform_branding_removable' => '1', 'push_enabled' => '1', 'sms_enabled' => '0', 'sms_monthly_limit' => '0', 'telegram_integration' => '1', 'vk_integration' => '1']],
        ];
