...
return [
    ...
    'definitions' => [
        ...
        'design_consultation_included' => ['group' => 'branding', 'type' => 'boolean', 'default' => 0, 'label' => 'Persönliche Designberatung inklusive'],
    ...
    'public' => [
        ...
        'design_consultation' => ['de' => 'Persönliche Designberatung', 'en' => 'Personal design consultation', 'ru' => 'Персональная консультация дизайнера', 'uk' => 'Персональна консультація дизайнера'],
