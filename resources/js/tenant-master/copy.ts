...
const copy: Record<MasterLocale, Record<string, string>> = {
    de: {
        ...
        image: "Bild",
        video: "Video",
        portfolioVideoHint: "MP4, WebM oder MOV. Die maximale Größe richtet sich nach Ihrem Tarif.",
    ...
    en: {
        ...
        image: "Image",
        video: "Video",
        portfolioVideoHint: "MP4, WebM or MOV. The maximum size depends on your plan.",
    ...
    ru: {
        ...
        image: "Изображение",
        video: "Видео",
        portfolioVideoHint: "MP4, WebM или MOV. Максимальный размер зависит от тарифа.",
    ...
    uk: {
        ...
        image: "Зображення",
        video: "Відео",
        portfolioVideoHint: "MP4, WebM або MOV. Максимальний розмір залежить від тарифу.",
