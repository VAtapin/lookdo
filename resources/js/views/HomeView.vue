      ...
      <div id="demo" class="public-phone-stage">
        ...
        <div class="app-phone request-phone">
          ...
          <div class="phone-screen customer-app-screen">
            <header class="phone-app-header"><span class="phone-mini-logo"><img decoding="async" :src="'/brand/lookdo-mark.webp'" alt="" aria-hidden="true"></span><b>LOOK.<em>DO.</em></b><span>♧</span></header>
