...
Object.assign(messages.ru, {
    ...
    audienceBrows:'Уход за бровями', bookingTitle:'Онлайн-запись', bookingText:'Услуги, свободное время, напоминания и повторные визиты.', socialTitle:'Контент и связь', socialText:'Подготовка публикаций и переход в реально подключённые каналы.', appAddress:'Адрес приложения', appAddressHelp:'Необязательно. Если оставить пустым, LOOKDO создаст адрес из названия бизнеса.',
});
