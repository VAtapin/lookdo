...
class PlatformData extends Command
{
    ...
    public function handle(DatabaseSeeder $seeder): int
    {
        ...
        $required = [
            ...
            'categories' => [BusinessCategory::class, ['automotive', 'repair-finishing-installation', 'general-services']],
            'variations' => [BusinessVariation::class, ['automotive.steering-wheel-upholstery', 'repair-finishing-installation.door-installation', 'general-services.general']],
            'templates' => [RequestTemplate::class, ['automotive.steering-wheel-upholstery', 'repair-finishing-installation.door-installation', 'general-services.general']],
        ];
        $missing = [];
